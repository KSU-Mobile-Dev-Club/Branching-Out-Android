...
public class GMapV2Direction {
    ...
    public Observable<Document> getDocument(final LatLng start, final LatLng end, final String mode) {
        return Observable.create((Observable.OnSubscribe<Document>) new Observable.OnSubscribe<Document>() {
            @Override
            public void call(Subscriber<? super Document> subscriber) {
                subscriber.onNext(getDoc(start, end, mode));
    ...
    private Document getDoc(LatLng start, LatLng end, String mode) {
